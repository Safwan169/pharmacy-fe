...
export function SettingsForm({ settings }: { settings: ShopSettings }) {
  ...
  return (
    <div className="grid gap-5 lg:grid-cols-3">
      <form action={action} className="space-y-4 lg:col-span-2" noValidate>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            <Field label={t("th.address")} htmlFor="shop_address">
          ...
          <Field label={t("settings.licence")} htmlFor="drug_license_no">
          ...
          <Field label={t("settings.paper")} htmlFor="receipt_width_mm">
          ...
          <div className="sm:col-span-2">
            <Field label={t("settings.footer")} htmlFor="receipt_footer" hint={t("settings.footerHint")}>
      ...
      <div>
        <p className="mb-2 text-xs font-medium tracking-wide text-muted uppercase">{t("settings.preview")}</p>
        <div
